...
class ApiKeyCreate(BaseModel):
    ...
    provider: str | None = Field(
        ...
        description=(
            ...
            "可选值：modelscope / zhipu / minimax / alibaba / tencent / baidu / deepseek / siliconflow / mock（仅测试）"
        ),
        example="modelscope",
    )
...
class ApiKeyResponse(BaseModel):
    ...
    provider: str | None = Field(..., description="厂商标识（仅厂商密钥有值）：modelscope / zhipu / minimax / alibaba / tencent / baidu / deepseek / siliconflow / mock")
